...
for sv in surveys:
    ...
    multipole_range = {f"{sv}_pa4_f150_in": [1250, 1800],
                       f"{sv}_pa4_f220_in": [1250, 2000],
                       f"{sv}_pa5_f090_in": [1000, 2000],
                       f"{sv}_pa5_f150_in": [800, 2000],
                       f"{sv}_pa6_f090_in": [1000, 2000],
                       f"{sv}_pa6_f150_in": [600, 2000],
                       f"{sv}_pa4_f150_out": [1250, 1800],
                       f"{sv}_pa4_f220_out": [1250, 2000],
                       f"{sv}_pa5_f090_out": [1000, 2000],
                       f"{sv}_pa5_f150_out": [800, 2000],
                       f"{sv}_pa6_f090_out": [1000, 2000],
                       f"{sv}_pa6_f150_out": [600, 2000]}

    # Define the reference arrays
    ref_map_sets[f"{sv}_pa4_f150_in"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa4_f220_in"] = "Planck_f217"
    ref_map_sets[f"{sv}_pa5_f090_in"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa5_f150_in"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa6_f090_in"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa6_f150_in"] = "Planck_f143"

    ref_map_sets[f"{sv}_pa4_f150_out"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa4_f220_out"] = "Planck_f217"
    ref_map_sets[f"{sv}_pa5_f090_out"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa5_f150_out"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa6_f090_out"] = "Planck_f143"
    ref_map_sets[f"{sv}_pa6_f150_out"] = "Planck_f143"
