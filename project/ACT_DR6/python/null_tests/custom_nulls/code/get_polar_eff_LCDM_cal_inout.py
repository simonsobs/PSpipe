...
Note that I assume that the spectra are uncalibrated and apply the calibration in this script
"""
...
my_surveys = d["surveys"]
try:
    my_surveys.remove("Planck")
except:
    pass

for sv in my_surveys:
    lmax_cal[f"{sv}_pa4_f220_in"] = 2000
    lmax_cal[f"{sv}_pa5_f090_in"] = 1200
    lmax_cal[f"{sv}_pa5_f150_in"] = 2000
    lmax_cal[f"{sv}_pa6_f090_in"] = 1200
    lmax_cal[f"{sv}_pa6_f150_in"] = 2000
    lmax_cal[f"{sv}_pa4_f220_out"] = 2000
    lmax_cal[f"{sv}_pa5_f090_out"] = 1200
    lmax_cal[f"{sv}_pa5_f150_out"] = 2000
    lmax_cal[f"{sv}_pa6_f090_out"] = 1200
    lmax_cal[f"{sv}_pa6_f150_out"] = 2000
