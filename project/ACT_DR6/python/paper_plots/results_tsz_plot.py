...
ax.errorbar(l_hydrosim, tSZ_hydrosim_low/tSZ_hydrosim_low[id_hydrosim],  label=hydro_sim_legend[0], linestyle='dotted', color="forestgreen", linewidth=1)
ax.errorbar(l_hydrosim, tSZ_hydrosim_high/tSZ_hydrosim_high[id_hydrosim],  label=hydro_sim_legend[1], linestyle='dotted', color="blue", linewidth=1)
