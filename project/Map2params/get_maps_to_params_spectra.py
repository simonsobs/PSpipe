...
lcut = d["lcut"]
write_splits_spectra = d["write_splits_spectra"]
...
all_freqs = [freq for exp in experiments for freq in freqs[exp]]
...
for iii in subtasks:
    #First we will generate our simulations and take their harmonics transform
    t0 = time.time()
    ...
    for exp in experiments:
        ...
        for fid ,freq in enumerate(freqs):
            ...
            l, bl = np.loadtxt("beam/beam_%s_%s.dat" %(exp, freq), unpack=True)
