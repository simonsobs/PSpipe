...
name["AxA-AxB"] = ["dr6_pa4_f220xdr6_pa4_f220-dr6_pa4_f220xPlanck_f217",
...
name["AxA-BxB"] = ["dr6_pa4_f220xdr6_pa4_f220-Planck_f217xPlanck_f217",
...
name["BxB-AxB"] = ["Planck_f217xPlanck_f217-dr6_pa4_f220xPlanck_f217",
...
xticks = ["AxA-AxB", "AxA-BxB", "BxB-AxB", "AxA-AxB", "AxA-BxB", "BxB-AxB", "AxA-AxB", "AxA-BxB", "BxB-AxB", "AxA-AxB", "AxA-BxB", "BxB-AxB", "AxA-AxB", "AxA-BxB", "BxB-AxB", "AxA-AxB", "AxA-BxB", "BxB-AxB"  ]
# open a file, where you stored the pickled data

for i, ar in enumerate(arrays):

    cal_list, std_list = [], []
    AxA_AxB = name["AxA-AxB"][i]
    AxA_BxB = name["AxA-BxB"][i]
    BxB_AxB = name["BxB-AxB"][i]
    for dir in dir_list:
        file = open(f"{dir}/calibs_dict.pkl", 'rb')
        data = pickle.load(file)

        cal_AxA_AxB, std_AxA_AxB = data[AxA_AxB]["calibs"]
        cal_AxA_BxB, std_AxA_BxB = data[AxA_BxB]["calibs"]
        cal_BxB_AxB, std_BxB_AxB = data[BxB_AxB]["calibs"]
        print(dir, ar)
#        print("AxA_AxB", cal_AxA_AxB)
        if dir == "calibration_results_npipe_bias_corrected_new_beams_fg_sub":
            if ar == "pa4_f220":
                print("BxB-AxB", cal_BxB_AxB)

            else:
                print("AxA_BxB", cal_AxA_BxB)
 #       print("BxB_AxB", cal_BxB_AxB)
        print("")
        cal_list += [cal_AxA_AxB]
        cal_list += [cal_AxA_BxB]
        cal_list += [cal_BxB_AxB]

        std_list += [std_AxA_AxB]
        std_list += [std_AxA_BxB]
        std_list += [std_BxB_AxB]
