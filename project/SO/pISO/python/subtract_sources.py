...
# TODO : take the mean across tube & splits
map_f090 = enmap.read_map(f'{act_map_path}/act_dr6.02_std_AA_night_pa5_f090_4way_set0_map.fits')
map_f090_srcfree = enmap.read_map(f'{act_map_path}/act_dr6.02_std_AA_night_pa5_f090_4way_set0_map_srcfree.fits')
map_f150 = enmap.read_map(f'{act_map_path}/act_dr6.02_std_AA_night_pa5_f150_4way_set0_map.fits')
map_f150_srcfree = enmap.read_map(f'{act_map_path}/act_dr6.02_std_AA_night_pa5_f150_4way_set0_map_srcfree.fits')
...
for task in subtasks:
    ...
    for i, map_fn in enumerate(d[f'maps_{sv}_{ar}']):
        ...
        enplot.write(f'{map_fn[:-5]}_srcfree.fits', enplot.plot(srcfree_map, downgrade=8, ticks=1, colorbar=True, range=(300, 100, 100)))
