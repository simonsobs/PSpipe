...
``project_maps_SPT_patch.py`` defines a CAR template around SPT survey and projects the SPT full maps, ivar (normalized ivar * 1e-2 to mimic a 5uK.arcmin depth, but we should look for raw ivar maps) and masks.
