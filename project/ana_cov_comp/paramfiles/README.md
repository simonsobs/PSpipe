...
```bash
alias 1pn="sbatch /home/zatkins/repos/simonsobs/PSpipe/project/data_analysis/paramfiles/della/1physicsnode.slurm $1"
```
...
```bash
for i in {0..4}; do \
    1pn "srun --cpus-per-task 1 --mem 48G --time 20:00 python -u python/get_window_dr6.py paramfiles/della/global_dr6_v4.dict $i $((i+1))"
done
```
