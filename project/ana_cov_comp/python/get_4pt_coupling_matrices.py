...
# iterate over all pairs/orders of fields, and get the canonized window pairs
for field_info1, field_info2, field_info3, field_info4 in product(field_infos, repeat=4):
    sv1, sv2, sv3, sv4 = field_info1[0], field_info2[0], field_info3[0], field_info4[0]
    ar1, ar2, ar3, ar4 = field_info1[1], field_info2[1], field_info3[1], field_info4[1]
    split1, split2, split3, split4 = field_info1[3], field_info2[3], field_info3[3], field_info4[3]
