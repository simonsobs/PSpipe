...
data_path = os.path.join(os.path.dirname(os.path.abspath(pspipe_utils.__file__)), "data/spectra/dr4")
...
for spec in ["TT", "TE", "EE"]:
    ...
    for fp in fp_list:
        ...
        lb, Db, sigmab = np.loadtxt(f"{like_product_dir}/spectra_xfreq_{spec}_{fp}.dat", unpack=True)
