...
for ar in d["arrays_dr6"]:
    ...
    # Concatenation
    spec_vec, full_cov = so_consistency.append_spectra_and_cov(ps_dict, cov_dict,
                                                               spectra_order)
    ...
    so_consistency.plot_residual(lb[id], res_spectrum[id], res_cov[np.ix_(id, id)],
...
pickle.dump(calib_dict, open(f"{output_dir}/polareff_dict.pkl", "wb"))
