...
for only_diag_corrections in [True, False]:
    mc_corrected_full_cov = mc_full_cov.copy()
    mc_corrected_full_cov = covariance.correct_analytical_cov(an_full_cov,
                                                              mc_corrected_full_cov,
