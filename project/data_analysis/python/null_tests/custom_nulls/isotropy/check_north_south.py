...
def pte_histo(pte_list, file_name, n_bins):
    ...
    plt.hist(pte_list, bins=bins, label=f"n tests: {n_samples}, min: {min:.3f}, max: {max:.3f}, [PTE>0.99]: {nPTE_high},  [PTE<0.01]: {nPTE_low} ")
...
lmin["dr6_pa4_f220", "EE"] = 500
lmin["dr6_pa5_f090", "EE"] = 500
lmin["dr6_pa5_f150", "EE"] = 500
lmin["dr6_pa6_f090", "EE"] = 500
lmin["dr6_pa6_f150", "EE"] = 500

lmin["dr6_pa4_f220", "BB"] = 500
lmin["dr6_pa5_f090", "BB"] = 500
lmin["dr6_pa5_f150", "BB"] = 500
lmin["dr6_pa6_f090", "BB"] = 500
lmin["dr6_pa6_f150", "BB"] = 500
...
lmin["dr6_pa4_f220", "EB"] = 500
lmin["dr6_pa5_f090", "EB"] = 500
lmin["dr6_pa5_f150", "EB"] = 500
lmin["dr6_pa6_f090", "EB"] = 500
lmin["dr6_pa6_f150", "EB"] = 500

lmin["dr6_pa4_f220", "BE"] = 500
lmin["dr6_pa5_f090", "BE"] = 500
lmin["dr6_pa5_f150", "BE"] = 500
lmin["dr6_pa6_f090", "BE"] = 500
lmin["dr6_pa6_f150", "BE"] = 500
...
g.write('<img src="' + 'isotropy/all_pte.png' + '" width="50%" /> \n')
...
for my_spec in spectra:
    ...
    for spec in spec_name_list:
        ...
        chi2 = np.sum((diff[id]- diff_bf[id]) ** 2 / diff_std[id] ** 2)
        ndof = len(lb[id])
...
pte_histo(pte_list, f"{null_dir}/all_pte.png", n_bins)
