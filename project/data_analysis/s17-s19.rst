...
Note that the instruction are given for running the full data analysis of s17 to s19, if you want to test the pipeline, we recommend to start
with a subset of the data for example using global_pa6_s19.dict (this will be way faster).
