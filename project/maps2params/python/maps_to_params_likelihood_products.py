...
print("full analytic cov is positive definite:", cov_utils.is_pos_def(full_cov))
print("trunc analytic cov is positive definite:", cov_utils.is_pos_def(trunc_cov))
print("full analytic cov is symmetric:", cov_utils.is_pos_def(full_cov))
print("trunc analytic cov is symmetric:", cov_utils.is_pos_def(trunc_cov))
