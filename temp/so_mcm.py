...
def dict_to_array(mcm):
    n_bins=mcm['spin0xspin0'].shape[0]
    mcm_array=np.zeros((9*n_bins,9*n_bins))
    mcm_array[0:n_bins,0:n_bins]=mcm['spin0xspin0']
    mcm_array[n_bins:2*n_bins,n_bins:2*n_bins]=mcm['spin0xspin2']
    mcm_array[2*n_bins:3*n_bins,2*n_bins:3*n_bins]=mcm['spin0xspin2']
    mcm_array[3*n_bins:4*n_bins,3*n_bins:4*n_bins]=mcm['spin2xspin0']
    mcm_array[4*n_bins:5*n_bins,4*n_bins:5*n_bins]=mcm['spin2xspin0']
    mcm_array[5*n_bins:9*n_bins,5*n_bins:9*n_bins]=mcm['spin2xspin2']
    return mcm_array
